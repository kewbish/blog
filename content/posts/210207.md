...
{{< figure src="/img/210207/0ChbUQV.png" alt="Figure 1. A graph showing articles read per day" caption="*Figure 1. Articles read per day.*" >}}
...
{{< figure src="/img/210207/CAnUol8.png" alt="Figure 2. A graph showing time distribution for article readings per day." caption="*Figure 2. Time distribution for article readings per day.*" >}}
...
However, I obviously wouldn't _fill in a form manually_ - we have automation to overengineer! Google Forms have a great link function, where you can autofill and submit a form from just a link. From the form link, something like:
